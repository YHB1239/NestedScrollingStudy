...
public class CustomNestedScrollingLayout extends LinearLayout implements NestedScrollingParent2 {
    ...
    public CustomNestedScrollingLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomNestedScrollingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
